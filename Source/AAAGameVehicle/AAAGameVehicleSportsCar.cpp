...
#include "AAAGameVehicleSportsCar.h"
#include "AAAGameVehicleSportsWheelFront.h"
#include "AAAGameVehicleSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AAAAGameVehicleSportsCar::AAAAGameVehicleSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAAAGameVehicleSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAAAGameVehicleSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAAAGameVehicleSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAAAGameVehicleSportsWheelRear::StaticClass();
