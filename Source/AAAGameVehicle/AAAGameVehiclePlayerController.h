...
#include "AAAGameVehiclePlayerController.generated.h"

class UInputMappingContext;
class AAAAGameVehiclePawn;
class UAAAGameVehicleUI;
 ...
 */
UCLASS(abstract)
class AAAAGameVehiclePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AAAAGameVehiclePawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AAAAGameVehiclePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UAAAGameVehicleUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UAAAGameVehicleUI> VehicleUI;
