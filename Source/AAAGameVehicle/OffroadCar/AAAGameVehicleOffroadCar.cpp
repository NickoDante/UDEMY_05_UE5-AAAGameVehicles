...
#include "AAAGameVehicleOffroadCar.h"
#include "AAAGameVehicleOffroadWheelFront.h"
#include "AAAGameVehicleOffroadWheelRear.h"
...
AAAAGameVehicleOffroadCar::AAAAGameVehicleOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAAAGameVehicleOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAAAGameVehicleOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAAAGameVehicleOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAAAGameVehicleOffroadWheelRear::StaticClass();
